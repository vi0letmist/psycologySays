    ...
    <div class="intro-container wow fadeIn">
      <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <p>I thought they would continue forever, But those harmless days Changed into something complicated and scary. I wonder if I’ll grow used to it, unawares…
    ...
    <section id="consul_head">
      <div class="container wow fadeInUp">
        <div class="row">
          ...
          <div class="col-lg-2">
            <a href="/ask/create" class="about-btn scrollto">Make Question</a>
          </div>
          <div class="col-lg-2">
